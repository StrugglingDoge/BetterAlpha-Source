    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        {
            startGame();
            BetterAlpha.getInstance().register();
        }
        catch(Exception exception)
        {
            exception.printStackTrace();
            ...
            do
            {
                ...
                if(Keyboard.getEventKeyState())
                {
                    ...
                    } else
                    {
                        ...
                        {
                        	//TODO: BetterAlpha
							BetterAlpha.onKeyPressed(Keyboard.getEventKey());
                        ...
                        for(int i = 0; i < 9; i++)
                        {
                            if(Keyboard.getEventKey() == 2 + i)
                            {
                                ...
                                //TODO: BetterAlpha
                                thePlayer.inventory.showToolTip();
                            }
                        }
    ...
    public static void func_6253_a(String s, String s1, String s2)
    {
        boolean flag = false;
        String s3 = s;
        Frame frame = new Frame("Minecraft (BetterAlpha v" + BetterAlpha.version + ")");
	...
	public NetClientHandler getSendQueue() {
		if (this.thePlayer instanceof EntityClientPlayerMP)
			return ((EntityClientPlayerMP) this.thePlayer).field_797_bg;
		return null;
	}
