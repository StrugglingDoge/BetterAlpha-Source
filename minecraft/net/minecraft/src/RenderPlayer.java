...
public class RenderPlayer extends RenderLiving
{
    ...
    protected void func_4015_a(EntityPlayer entityplayer, float f)
    {
        ...
        if(loadDownloadableImageTexture(entityplayer.playerCloakUrl, null))
        {
            ...
            float f8 = entityplayer.field_734_o + (entityplayer.field_735_n - entityplayer.field_734_o) * f;
            ...
            f9 += MathHelper.sin((entityplayer.field_9291_aR + (entityplayer.field_9290_aS - entityplayer.field_9291_aR) * f) * 6F) * 32F * f12;
            if(entityplayer.func_381_o())
            {
                f9 += 25F;
            }
