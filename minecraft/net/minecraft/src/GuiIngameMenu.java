...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        updateCounter2 = 0;
        controlList.clear();
        controlList.add(new GuiButton(1, width / 2 - 100, height / 4 + 96, "Save and quit to title"));
        if(mc.isMultiplayerWorld())
        {
            ((GuiButton)controlList.get(0)).displayString = "Disconnect";
        }
        controlList.add(new GuiButton(3, width / 2 - 100, height / 4 + 48, "Mods and Texture Packs"));
        controlList.add(new GuiButton(4, width / 2 - 100, height / 4 + 24, "Back to game"));
        controlList.add(new GuiButton(0, width / 2 - 100, height / 4 + 72, "Options..."));
    }
