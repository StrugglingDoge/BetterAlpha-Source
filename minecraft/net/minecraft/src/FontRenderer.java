...
public class FontRenderer {
	...
	public FontRenderer(GameSettings gamesettings, String s, RenderEngine renderengine) {
		...
		for (int j1 = 0; j1 < 32; j1++) {
			...
			this.colorCode[j1] = (l2 & 0xFF) << 16 | (j3 & 0xFF) << 8 | k3 & 0xFF;
			GL11.glEndList();
		}
	...
	public void renderString(String s, int i, int j, int k, boolean flag) {
		...
		for (int i1 = 0; i1 < s.length(); i1++) {
			...
			int k1 = " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_'abcdefghijklmnopqrstuvwxyz{|}~\u2302\307\374\351\342\344\340\345\347\352\353\350\357\356\354\304\305\311\346\306\364\366\362\373\371\377\326\334\370\243\330\327\u0192\341\355\363\372\361\321\252\272\277\256\254\275\274\241\253\273"
					.indexOf(s.charAt(i1));
			if (k1 >= 0) {
	...
	public int getStringWidth(String s) {
		...
		for (int j = 0; j < s.length(); j++) {
			...
			int k = " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_'abcdefghijklmnopqrstuvwxyz{|}~\u2302\307\374\351\342\344\340\345\347\352\353\350\357\356\354\304\305\311\346\306\364\366\362\373\371\377\326\334\370\243\330\327\u0192\341\355\363\372\361\321\252\272\277\256\254\275\274\241\253\273"
					.indexOf(s.charAt(j));
			if (k >= 0) {
				i += charWidth[k + 32];
			}
