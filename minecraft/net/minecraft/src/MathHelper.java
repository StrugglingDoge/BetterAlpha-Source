...
public class MathHelper
{
    ...
    //TODO: BetterAlpha
    public static float getMax(float[] findLongest) {
		float maxValue = findLongest[0];
		for (int i = 1; i < findLongest.length; i++) {
			if (findLongest[i] > maxValue) {
				maxValue = findLongest[i];
			}
		}
		return maxValue;
	}
