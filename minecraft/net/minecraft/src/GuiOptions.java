...
public class GuiOptions extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        controlList.add(new GuiButton(102, width / 2 - 100, height / 6 + 72 + 12, stringtranslate.translateKey("Better Alpha Settings...")));
    ...
    protected void actionPerformed(GuiButton guibutton)
    {
        ...
        {
            mc.gameSettings.saveOptions();
            mc.displayGuiScreen(new GuiBetterAlphaSettings(this, options));
        }
    }
