...
public class GlStateManager
{
    ...
    public static void bindTexture(final int p_179144_0_) {
        if (p_179144_0_ != GlStateManager.textureState[GlStateManager.activeTextureUnit].field_179059_b) {
            GL11.glBindTexture(3553, GlStateManager.textureState[GlStateManager.activeTextureUnit].field_179059_b = p_179144_0_);
        }
    }
    ...
    public enum TexGen
    {
        ...
        private TexGen(final String name, final int ordinal, final String p_i46255_1_, final int p_i46255_2_) {
        }
    }
